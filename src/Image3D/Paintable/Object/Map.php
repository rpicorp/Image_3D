 ...
 */
class Map extends PaintableObject {
    ...
    public function addRow($row)
    {
        ...
        foreach ($row as $point) {
            if (is_object($point) && ($point instanceof Point)) $this->_points[$rowNbr][] = $point;
        }
...
//        if ($option === Image3D::IMAGE_3D_OPTION_BF_CULLING) $value = false;
