...
abstract class Renderer
{
     ...
     *
     * @param PaintableObject $object PaintableObject to merge
     *
     * @return  void
     */
    protected function _getPolygones(PaintableObject $object)
    {
    ...
    public function addObjects($objects)
    {
        if (is_array($objects)) {
            foreach ($objects as $object) {
                if ($object instanceof PaintableObject) {
                    $this->_getPolygones($object);
                }
            }
        } elseif ($objects instanceof PaintableObject) {
