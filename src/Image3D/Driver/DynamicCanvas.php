 ...
 */
class DynamicCanvas extends Driver
{
    ...
    /**
     * Create an appropriate array representation from a Color object
     *
     * @param Color $color Color to transform to rgba syntax
     * @param float          $alpha optional Override the alpha value set in the Color object
     *
     * @return array Array of color values reflecting the different color
     *               components of the input object
     */
    protected function _getRgba(Color $color, $alpha = null)
    {
        ...
        return str_replace($identifiers,
            ...
            implode("\n\n",
                array_map(create_function('$jsfile',
                         ('return file_get_contents(__DIR__ . "/../../../data/DynamicCanvas/" . $jsfile);')
                          ),
                    $jsfiles)));
    }
